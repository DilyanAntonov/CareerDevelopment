...
urlpatterns = [
    ...
    path('company/info/<int:pk>/', views.CompanyInfo.as_view(), name='company-info'),
    ...
    path('create-job-listing', views.JobListingCreateView.as_view(), name='create-job-listing'),
    ...
    path('monitor-job-listing/<int:pk>/', views.JobListingMonitorView.as_view(), name='monitor-job-listing'),
]
